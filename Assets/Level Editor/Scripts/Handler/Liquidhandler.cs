...
namespace LevelBuilder
{
    public class Liquidhandler : MonoBehaviour
    {
        ...
        {
            if (LevelCreateManager.Singleton.FloorHandler.floorDictionary.TryGetValue(LevelCreateManager.GetTileKey(gridPos),out TileProperty floorProperty) &&
                ...
                !LevelCreateManager.Singleton.PlatformHandler.tileDictionary.ContainsKey(LevelCreateManager.GetTileKey(gridPos.x, gridPos.y)) &&
